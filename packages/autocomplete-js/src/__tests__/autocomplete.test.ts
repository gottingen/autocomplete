import { createAlgoliaInsightsPlugin } from '@kumoai/autocomplete-plugin-algolia-insights';
import * as autocompleteShared from '@kumoai/autocomplete-shared';
...
jest.mock('@kumoai/autocomplete-shared', () => {
  const module = jest.requireActual('@kumoai/autocomplete-shared');
