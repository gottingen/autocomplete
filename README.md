...
[![Version](https://img.shields.io/npm/v/@kumoai/autocomplete-js.svg?style=flat-square)](https://www.npmjs.com/package/@kumoai/autocomplete-js) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=flat-square)](LICENSE)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@kumoai/autocomplete-js"></script>
<script>
  const { autocomplete } = window['@kumoai/autocomplete-js'];
</script>
```
